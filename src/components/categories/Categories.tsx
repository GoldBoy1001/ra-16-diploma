...
export default function Categories() {
  ...
  const clickedCategory = useTypedSelector(
    (state) => state.category.isClickedCategory
  );
      ...
      <ul className="catalog-categories nav justify-content-center">
        <li className="nav-item">
          <a
            ...
            className={clickedCategory === " " ? "nav-link active" : "nav-link"}
            href=""
          >
            Все
          </a>
        ...
        <li className="nav-item">
          <a
            ...
            className={
              clickedCategory === "12" ? "nav-link active" : "nav-link"
            }
            href="#"
          >
            Женская обувь
        ...
        <li className="nav-item">
          <a
            ...
            className={
              clickedCategory === "13" ? "nav-link active" : "nav-link"
            }
            href="#"
          >
            Мужская обувь
        ...
        <li className="nav-item">
          <a
            ...
            className={
              clickedCategory === "14" ? "nav-link active" : "nav-link"
            }
            href="#"
          >
            Обувь унисекс
        ...
        <li className="nav-item">
          <a
            ...
            className={
              clickedCategory === "15" ? "nav-link active" : "nav-link"
            }
            href="#"
          >
            Детская обувь
